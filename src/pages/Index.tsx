    ...
    <>
      ...
      <div className="bg-gradient-to-br from-rose-50 via-orange-50 to-amber-50">
        <section id="activities-section" className="container mx-auto px-4 py-16">
          ...
          {/* Create & Express Group */}
          <div className="mb-16">
            <h3 className="text-2xl font-bold text-center mb-8 bg-gradient-to-r from-cyan-600 to-amber-600 text-transparent bg-clip-text">
              Create & Express
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {activities.slice(0, 2).map((activity) => {
                ...
                return (
                  ...
                  >
                    <div className={`absolute inset-0 bg-gradient-to-br ${activity.bgGradient} rounded-3xl transform group-hover:scale-105 transition-transform duration-300`}></div>
                    <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-white/20">
                      {/* Icon */}
                      <div className="mb-6">
                        <div className={`w-16 h-16 bg-gradient-to-br ${activity.gradient} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
                      ...
                      <Link to={activity.path}>
                        <Button className={`w-full bg-gradient-to-r ${activity.gradient} hover:opacity-90 text-white py-4 rounded-2xl font-semibold transform group-hover:scale-105 transition-all duration-200 shadow-lg`}>
                          Get Started
          ...
          {/* Think & Learn Group */}
          <div className="mb-16">
            <h3 className="text-2xl font-bold text-center mb-8 bg-gradient-to-r from-violet-600 to-emerald-600 text-transparent bg-clip-text">
              Think & Learn
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          {/* Explore & Discover Group */}
          <div className="mb-16">
            <h3 className="text-2xl font-bold text-center mb-8 bg-gradient-to-r from-indigo-600 to-orange-600 text-transparent bg-clip-text">
              Explore & Discover
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {[activities[4], activities[6]].map((activity) => {
                ...
                return (
                  <div
                    ...
                    style={{ animationDelay: activity.delay }}
                  >
                    <div className={`absolute inset-0 bg-gradient-to-br ${activity.bgGradient} rounded-3xl transform ${!isComingSoon ? 'group-hover:scale-105' : ''} transition-transform duration-300`}></div>
                    <div className={`relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl ${!isComingSoon ? 'hover:shadow-2xl' : ''} transition-all duration-300 border border-white/20 ${isComingSoon ? 'cursor-not-allowed' : ''}`}>
                      {/* Coming Soon Badge */}
                      {isComingSoon && (
                      ...
                      {/* Icon */}
                      <div className="mb-6">
                        <div className={`w-16 h-16 bg-gradient-to-br ${activity.gradient} rounded-2xl flex items-center justify-center mb-4 ${!isComingSoon ? 'group-hover:scale-110' : ''} transition-transform duration-300 ${isComingSoon ? 'opacity-60' : ''}`}>
                          <IconComponent className="h-8 w-8 text-white" />
                        </div>
                      </div>

                      {/* Content */}
                      <h3 className={`text-2xl font-bold mb-4 ${isComingSoon ? 'text-gray-600' : 'text-gray-800'}`}>
                        {activity.title}
                      </h3>
                      <p className={`mb-6 leading-relaxed ${isComingSoon ? 'text-gray-500' : 'text-gray-600'}`}>
                        {activity.description}
                      </p>
                      ...
                      {isComingSoon ? (
                        <Button 
                          disabled 
                          className="w-full bg-gray-300 text-gray-500 py-4 rounded-2xl font-semibold cursor-not-allowed opacity-60"
                        >
                          Coming Soon
          ...
          {/* Test & Challenge Group */}
          <div className="mb-16">
            <h3 className="text-2xl font-bold text-center mb-8 bg-gradient-to-r from-lime-600 to-green-600 text-transparent bg-clip-text">
              Test & Challenge
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
