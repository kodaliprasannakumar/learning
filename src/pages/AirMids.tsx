...
export default function AirMids() {
  ...
  useEffect(() => {
    const phases = [
      { delay: 500, phase: 1 },   // Show "Middle"
      { delay: 1500, phase: 2 },  // Show "School"
      { delay: 2200, phase: 3 },  // Show "AI"
      { delay: 2900, phase: 4 },  // Show "Adventures"
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative h-[95vh] bg-gradient-to-br from-green-50/30 via-blue-50/20 to-purple-50/30 overflow-hidden -mt-32 pt-32">
            ...
            <div className="animate-fade-in">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold mb-8">
                <div className="overflow-hidden">
                  <span 
                    className={`bg-gradient-to-r from-green-600 via-blue-600 via-purple-600 to-pink-600 text-transparent leading-[1.2] bg-clip-text inline-block transform transition-all duration-1000 ease-out ${
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Button 
                  ...
                  className="bg-gradient-to-r from-green-600 via-blue-600 to-purple-600 hover:from-green-700 hover:via-blue-700 hover:to-purple-700 text-white px-8 py-4 text-lg rounded-full shadow-xl transform hover:scale-105 transition-all duration-200"
                >
                  <Play className="mr-2 h-5 w-5" />
                  Start Learning
                </Button>
                <Button variant="outline" className="border-2 border-blue-200 hover:border-blue-300 px-8 py-4 text-lg rounded-full">
      ...
      {/* Activities Grid */}
      <section id="activities-section" className="bg-gradient-to-br from-green-50/30 via-blue-50/20 to-purple-50/30 py-16">
